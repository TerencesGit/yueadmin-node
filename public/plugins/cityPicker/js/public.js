(function() {
	var citySelectHtml =$('<div class="provinceCityAll">\
	...
	$(".proCitySelAll").click(function(event) {
		...
		var t2 = o2.top;
		var h2 = $(this).height();
		$(".provinceCityAll").css("top", t2 + h2 + 16).css("left", l2).toggle();
...
function sendCitiesAjax() {
	$.ajax({
		type: "get",
		url: '/plugins/cityPicker/js/queryAllCities.js',
		async: false,
		dataType: "json",
...
function sendAllProvinceAjax() {
	$.ajax({
		type: "get",
		url: '/plugins/cityPicker/js/queryAllProvinces.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCitiesAjax() {
	$.ajax({
		type: "get",
		url: '/plugins/cityPicker/js/queryCities.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCountiesAjax()
 {
	$.ajax({
		type: "get",
		url: "/plugins/cityPicker/js/queryAllAreas.js",
		async: false,
		dataType: "json",
		success: function(data) {
			allAreas = data.areas;
